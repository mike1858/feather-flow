---
name: feather:add-convex-auth-testing
description: "Checklist: Can tests use <Authenticated>, useConvexAuth(), useAuthActions()? Verify or add vitest plugin, renderWithConvexAuth export, @convex-dev/auth dep. Add-on to feather:setup-convex-testing."
---
...
**Prerequisite:** `/feather:setup-convex-testing` must be completed first.
